...
<template>
    <header class="rounded-lg bg-gradient-to-r from-cyan-600 to-cyan-800 px-1 py-3 text-centerfont-semibold text-white shadow-md hover:from-cyan-700 hover:to-cyan-900 focus:outline-none focus:ring-2 focus:ring-cyan-600 focus:ring-opacity-50 transition duration-300 md:text-base">      
        <nav class="mx-auto max-w-screen-xl px-6 py-4 lg:px-12">
            <div class="flex items-center justify-between">
                <router-link to="/" class="flex items-center text-white">   
                    <div class="flex items-center">
                        <div class="w-16 h-16 flex-shrink-0 rounded-full overflow-hidden">
                            <img src="../images/profile.jpg" alt="Profile Image" class="w-full h-full object-cover" />
                        </div>
                        <div class="ml-4">
                            <h1 class="font-bold text-xl md:text-2xl text-white">Cliyent Siclot</h1>
                            <p class="font-light text-sm md:text-lg text-gray-300">BSIT Student</p>
                        </div>
                    </div> 
                </router-link>
                ...
                <div class="hidden lg:flex lg:items-center lg:justify-end">
                    <ul class="flex flex-row gap-8">
                        <li :class="$route.name === 'home' ? 'text-white font-medium text-lg' : 'text-gray-200 hover:text-white font-normal text-lg'">
                            <router-link to="/" class="transition-colors duration-300">Home</router-link>
                        </li>
                        <li :class="$route.name === 'about' ? 'text-white font-medium text-lg' : 'text-gray-200 hover:text-white font-normal text-lg'">
                            <router-link to="/about" class="transition-colors duration-300">About</router-link>
                        </li>
                        <li :class="$route.name === 'projects' ? 'text-white font-medium text-lg' : 'text-gray-200 hover:text-white font-normal text-lg'">
                            <router-link to="/projects" class="transition-colors duration-300">Projects</router-link>
                        </li>
                        <li :class="$route.name === 'contact' ? 'text-white font-medium text-lg' : 'text-gray-200 hover:text-white font-normal text-lg'">
                            <router-link to="/contact" class="transition-colors duration-300">Contact</router-link>
                        </li>
                    </ul>
                </div>
            ...
            <div v-if="isOpenMenu" class="flex lg:hidden relative">
                ...
                <div class="bg-white flex flex-col absolute top-[18px] left-1/2 transform -translate-x-1/2 w-screen max-w-xs gap-4 shadow-lg p-6 rounded">
                    <router-link to="/"
